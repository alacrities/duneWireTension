...
HD_PWD='/home/nate/projects/duneWireTension/vivadoProjects/cores/cores.runs/clk_sysclk_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_sysclk_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_sysclk_mmcm.tcl
