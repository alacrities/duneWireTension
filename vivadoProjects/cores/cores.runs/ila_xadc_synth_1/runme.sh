...
HD_PWD='/home/nate/projects/duneWireTension/vivadoProjects/cores/cores.runs/ila_xadc_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_xadc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_xadc.tcl
