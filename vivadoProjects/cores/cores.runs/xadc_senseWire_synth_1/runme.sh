...
HD_PWD='/home/nate/projects/duneWireTension/vivadoProjects/cores/cores.runs/xadc_senseWire_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_senseWire.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_senseWire.tcl
