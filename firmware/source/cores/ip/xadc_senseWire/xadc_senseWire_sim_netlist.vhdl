...
entity xadc_senseWire_drp_to_axi4stream is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xadc_senseWire_xadc_senseWire_xadc_core_drp is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 );
    m_axis_tid : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
drp_to_axi4stream_inst: entity work.xadc_senseWire_drp_to_axi4stream
     port map (
      AR(0) => m_axis_reset,
      CHANNEL(4 downto 0) => \^channel_out\(4 downto 0),
      DO(15 downto 0) => do_C(15 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity xadc_senseWire_xadc_senseWire_axi_xadc is
  port (
    s_axis_aclk : in STD_LOGIC;
    m_axis_aclk : in STD_LOGIC;
    m_axis_resetn : in STD_LOGIC;
...
begin
AXI_XADC_CORE_I: entity work.xadc_senseWire_xadc_senseWire_xadc_core_drp
     port map (
      VAUXN(1) => vauxn8,
      VAUXN(0) => vauxn0,
      VAUXP(1) => vauxp8,
...
entity xadc_senseWire is
  ...
  attribute NotValidForBitStream of xadc_senseWire : entity is true;
end xadc_senseWire;

architecture STRUCTURE of xadc_senseWire is
  signal NLW_U0_alarm_out_UNCONNECTED : STD_LOGIC_VECTOR ( 6 downto 0 );
begin
U0: entity work.xadc_senseWire_xadc_senseWire_axi_xadc
     port map (
